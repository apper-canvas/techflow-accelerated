...
function AppContent() {
  ...
  if (!isInitialized) {
    return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-surface-50 via-blue-50 to-indigo-50 dark:from-surface-900 dark:via-surface-800 dark:to-surface-900">
      <div className="text-lg text-surface-600 dark:text-surface-400">Initializing application...</div>
    </div>;
  }
